...
$APPLICATION->SetTitle("Отзыва клиентов");?><div class="tb20-bottom">
	Компания специализируется на предоставлении услуг по утеплению фасадов домов "мокрого" типа с внешним тонким армирующе-клеевым слоем и финишной декоративной штукатуркой. Деятельность компании получила высокую оценку клиентов.<br>
	<br>
</div>
<hr>

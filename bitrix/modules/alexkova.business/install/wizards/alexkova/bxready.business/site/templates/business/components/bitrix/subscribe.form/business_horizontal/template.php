                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 bxr-subscribe-motto">
                        <div class="bxr-subscribe-text"><span class="bxr-ico-mail">
                           ...
                           <?=GetMessage("news_reviews_promotions")?></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-xs-12 <?if(!isset($arParams["SHOW_RUBRICS"]) || $arParams["SHOW_RUBRICS"]=="N") echo "col-sm-12"; else echo "col-sm-6";?> bxr_subscribe_submit_container">

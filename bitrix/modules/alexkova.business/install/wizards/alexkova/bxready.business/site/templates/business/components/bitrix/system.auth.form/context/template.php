...
<div class="bx_login_block">
	...
	$frame = $this->createFrame("login-line", false)->begin();
		...
		?>
			...
			<a class="bx_login_top_inline_link mono" href="javascript:void(0)<?//=$arResult["AUTH_URL"]?>" onclick="openAuthorizePopup()">
				<span class="fa fa-user"></span>
				<?=GetMessage("AUTH_LOGIN_")?>
			</a>/<?if($arResult["NEW_USER_REGISTRATION"] == "Y"):?>
			<a class="bx_login_top_inline_link mono" href="<?=$arResult["AUTH_REGISTER_URL"]?>" >
				<?=GetMessage("AUTH_REGISTER_")?></a>
			<?endif;
		}
		else
		{
		...
		?>
			...
			<a class="bx_login_top_inline_link bxr-font-color" href="<?=$APPLICATION->GetCurPageParam("logout=yes", Array("logout"))?>">				
                            <span class="bxr-font-color"><?=GetMessage("AUTH_LOGOUT")?></span></a>
		<?
		}
	$frame->beginStub();
		?>
		<a class="bx_login_top_inline_link" href="javascript:void(0)<?//=$arResult["AUTH_URL"]?>" onclick="openAuthorizePopup()">
			<?=GetMessage("AUTH_LOGIN")?></a>

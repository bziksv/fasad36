...
if(COption::GetOptionString("alexkova.market", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
...
COption::SetOptionString("alexkova.market", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>
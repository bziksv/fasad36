...
<div class="bxr-element-ecommerce-lite-v1" data-uid="<?=$UID?>" data-resize="1" id="<?=$UID?>">
    <div class="bxr-element-container">
        ...
        <div class="bxr-element-price" id="<?=$UID?>_price">
            <? if($arElement["PROPERTIES"]["BXR_INSTOCK"]["VALUE_XML_ID"] == "Y") include('price.php'); ?>
        </div>
        <div class="bxr-element-action <?if($hideElements === true):?>js-buy-button<?endif;?>"  id="<?=$UID?>_basket_actions"

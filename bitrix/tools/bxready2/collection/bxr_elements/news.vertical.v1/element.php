...
if(intval($arElementParams["UNICUM_ID"])>0){
    $UID = $arElementParams["UNICUM_ID"]>0 ? $arElementParams["UNICUM_ID"] : 1;
}
?>
<div class="bxr-news-vertical-v1 <?if(isset($arElementParams["BXR_PRST_SHOW_BORDER"]) && $arElementParams["BXR_PRST_SHOW_BORDER"]=="Y") echo "bxr-border-color bxr-border-color-hover";?>" data-uid="<?=$UID?>" data-resize="1">
    <div class="bxr-section-container">
        <div class="bxr-element-image">
            <a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img src="<?=$picture["src"]?>" alt="<?=$arElement['NAME']?>"></a>
        </div>
        <div class="bxr-element-content <?if(isset($arElementParams["BXR_PRST_STYLE"]) && $arElementParams["BXR_PRST_STYLE"]=="left") echo "left";?>">
...
<?
$elementDraw->setAdditionalFile("CSS", "/bitrix/tools/bxready2/collection/bxr_elements/news.vertical.v1/include/style.css", false);
if($arElementParams["BXREADY_VERTICAL_ALIGN"] != 'N')
    $elementDraw->setAdditionalFile("JS", "/bitrix/tools/bxready2/collection/bxr_elements/news.vertical.v1/include/script.js", false);
?>
...
<div class="bxr-section-horizontal-v2" data-uid="<?=$UID?>" data-resize="1">
    <div class="bxr-section-container">
        ...
        <div class="bxr-element-content">
            ...
            <?if (strlen($arElement["UF_PREVIEW"])>0):?>
                    <div class="bxr-element-description">
					
                            <?=$arElement["UF_PREVIEW"]?>
                    </div>
            <?endif;?>
...
<?
$elementDraw->setAdditionalFile("CSS", "/bitrix/tools/bxready2/collection/bxr_elements/section.horizontal.v2/include/style.css", false);
if($arElementParams["BXREADY_VERTICAL_ALIGN"] != 'N')
    $elementDraw->setAdditionalFile("JS", "/bitrix/tools/bxready2/collection/bxr_elements/section.horizontal.v2/include/script.js", false);
?>
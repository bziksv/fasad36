    ...
    <table class="bxr-element-container">
        <tr>
            ...
            <td class="bxr-element-btn-col">
                <div class="bxr-element-action <?if($hideElements === true):?>js-buy-button<?endif;?>"  id="<?=$arItemIDs["BASKET_ACTIONS"]?>"
									data-linkhref="<?=$arElement["DETAIL_PAGE_URL"]?>"
									data-linkid="<?=$arItemIDs["BUY_LINK"]?>"
									data-linkname="<?=GetMessage("MORE_INFO_TITLE")?>"
								>
...
<?
$elementDraw->setAdditionalFile("JS", "/bitrix/tools/bxready2/collection/bxr_elements/ecommerce.table.lite.v1/include/showHiddenElements.js", true);

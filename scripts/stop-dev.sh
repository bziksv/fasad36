...
lsof -ti:9094 2>/dev/null | xargs kill 2>/dev/null || true
...
sleep 1
lsof -ti:8094 2>/dev/null | xargs kill -9 2>/dev/null || true
lsof -ti:9094 2>/dev/null | xargs kill -9 2>/dev/null || true

echo "stopped (:8094 / :9094)"

...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
			<div class="bxr-list">
				<div class="tb20-bottom txtTrans h2">Каталог товаров</div>
				<p class="tb30-bottom">
...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
			<div class="bxr-list">
				<div class="tb20-bottom txtTrans h2">Проекты</div>
				<p class="tb30-bottom">
...
<div class="container tb20-bottom">
	<div class="row">
		<div class="col-xs-12">
			<div class="bxr-list">
				<div class="tb20-bottom txtTrans h2">Отзывы наших клиентов</div>
				<p class="tb30-bottom">
...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
			<div class="bxr-list">
				<div class="tb20-bottom txtTrans h2">Новости</div>
			</div>
			 <?$APPLICATION->IncludeComponent(
	"bxready2:block.list",
	".default",
...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
			<div class="bxr-list">
				<div class="tb20-bottom txtTrans h2">Статьи и обзоры</div>
			</div>
			 <?$APPLICATION->IncludeComponent(
	"bxready2:block.list",
	"",
